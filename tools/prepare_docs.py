...
PAGE_META = {
    ...
    "Upgrading.md": "Upgrade nai-security: 1.15.0 deploy checks; 1.14.1 startup-crash fixes; 1.14.0 path blocking (migrations 0006 + 0007); 1.13.0 Django 5.2 floor, requests 2.32.4, celery extra; 1.12.0 proxy-header change.",
}
